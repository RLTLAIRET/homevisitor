...
try {
    ...
    $mail->Username   = 'rltdvr@gmail.com';                     //SMTP username
    $mail->Password   = 'shock007';                               //SMTP password
    $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;            //Enable implicit TLS encryption
    $mail->Port       = 465;                                    //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`

    //Recipients
    $mail->setFrom('rltdvr@gmail.com', 'Visitor Plus');
    ...
    $mail->isHTML(true);    
    if ($asunto="") {
        $mail->Subject = 'Visitor Plus:'. $nombre;  
    } else {
